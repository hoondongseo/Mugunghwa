  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        <h3 className="text-3xl font-bold text-gray-900 mb-4">전국 참여 현황</h3>
        <p className="text-lg text-gray-600">지역별 응원 메시지 현황을 확인해보세요</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <div className="text-sm text-gray-600">피어난 무궁화</div>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-xl font-bold text-gray-900">지역별 참여 순위</CardTitle>
        </CardHeader>
        <CardContent>
              ...
              <div key={region.region} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">{region.messageCount}개 무궁화</div>
                  </div>
                </div>
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-600 min-w-[40px]">{region.percentage}%</span>
                </div>
              </div>
            ))}
          </div>
